...
else return"local "..v.."="..n.."-"..math.random(1,50).."; "end
end
local Unparser={}
function Unparser:new()
local obj={varMap={},encryptionKey=math.random(50,200),output="",junkCounter=0,junkInterval=math.random(6,10)}
